...
# Re-apply the post-CTS constraint overrides so detailed-route's STA sees
# propagated clocks and any post-CTS path-exception clean-ups (the
# checkpoint zip only carries the original pre-CTS SDC).
read_sdc src/constraints_postcts.sdc
