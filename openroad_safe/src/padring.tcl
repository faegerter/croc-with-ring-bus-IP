...
place_pad -row IO_EAST  -location [expr {$eastStart +  3*$eastPitch}] "pad_slink_credit_rtrn_clk_o"    ; # pin no:  4
place_pad -row IO_EAST  -location [expr {$eastStart +  4*$eastPitch}] "pad_slink_credit_recv_clk_i"    ; # pin no:  5
place_pad -row IO_EAST  -location [expr {$eastStart +  5*$eastPitch}] "pad_slink_ddr_rcv_clk_o"    ; # pin no:  6
...
place_pad -row IO_NORTH -location [expr {$northStart - 10*$northPitch}] "pad_slink_ddr_rcv_clk_i"       ; # pin no: 11
